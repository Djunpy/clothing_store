...
urlpatterns = [
    path('', cache_page(60 * 15), views.HomePageView.as_view(), name='home-page'),
    path('authorization/', views.AuthorizationPageView.as_view(), name='authorization'),
    path('products/', cache_page(60 * 15), views.ProductsView.as_view(), name='products'),
    path('order-summary/', views.OrderSummaryView.as_view(), name='order-summary'),
    path('by-gender/', views.ByGenderView.as_view(), name='by-gender'),
    path('remove_from_cart/<int:pk>/', views.remove_from_cart, name='remove_from_cart'),
    path('by-category/<slug:slug>/', cache_page(60 * 15), views.ByCategoryView.as_view(), name='by-category'),
